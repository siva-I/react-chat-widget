...
function WidgetLayout({
  ...
  const eventHandle = (evt) => {
    if (evt.target && evt.target.className === "ua-message-img") {
      const {
        src,
        alt,
        naturalWidth,
  ...
  return (
    <div
      className={cn("ua-widget-container", {
        "ua-full-screen": fullScreenMode,
        "ua-previewer": imagePreview,
        "ua-close-widget-container ": !showChat,
      })}
    >
      {showChat && (
        <Conversation
