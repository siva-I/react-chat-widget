...
function Sender(
  ...
  return (
    <div ref={refContainer} className="ua-sender">
      <button
        className="ua-picker-btn"
        type="submit"
        onClick={handlerPressEmoji}
      >
        <img src={emoji} className="ua-picker-icon" alt="" />
      </button>
      <div
        className={cn("ua-new-message", {
          "ua-message-disable": disabledInput,
        })}
      >
        <div
          spellCheck
      ...
      <button type="submit" className="ua-send" onClick={handlerSendMessage}>
        <img src={send} className="ua-send-icon" alt={buttonAlt} />
      </button>
    </div>
  );
}
